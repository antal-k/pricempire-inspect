    ...
    async ensureSchema() {
        ...
        BEGIN
            ...
            IF NEW.a < OLD.a THEN
                ...
                INSERT INTO history VALUES (NEW.floatid, NEW.a, NEW.ms, NEW.updated, NULL, OLD.ms) ON CONFLICT DO NOTHING;
            ...
            IF (OLD.ms != NEW.ms) OR OLD.price IS NOT NULL THEN
                ...
                INSERT INTO history VALUES (NEW.floatid, OLD.a, OLD.ms, OLD.updated, OLD.price, NEW.ms);
            END IF;
